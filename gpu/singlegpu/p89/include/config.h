...
#define COFACTOR 37
#define PC_DEPTH 12
#define PC_STRATEGY_SIZE_0 7
#define PC_STRATEGY_SIZE_1 7

#define EXPONENT2 42
#define EXPONENT2_BITS 42
#define EXPONENT2_MASK 0x3
#define EXP2_MASK_GPU 0x3FF
...
extern __device__ limb_t STRATEGY2[41];
extern __device__ limb_t STRATEGY2_0[20];
extern __device__ limb_t STRATEGY2_1[20];

extern __device__ limb_t STRATEGY2_REDUCED_0[19];
extern __device__ limb_t STRATEGY2_REDUCED_1[19];
extern __device__ limb_t STRATEGY2_PC_0[7];
extern __device__ limb_t STRATEGY2_PC_1[7];

#define EXPONENT3 26
#define EXPONENT3_BITS 42
#define EXPONENT3_MASK 0x3
#define EXP3_MASK_GPU 0x3FF

extern __device__ uint32_t STRATEGY3[25];
extern const uint32_t STRATEGY3_0[12];
extern const uint32_t STRATEGY3_1[12];
