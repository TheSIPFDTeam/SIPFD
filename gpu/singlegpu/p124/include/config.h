...
#define COFACTOR 155
#define PC_DEPTH 16
#define PC_STRATEGY_SIZE_0 11
#define PC_STRATEGY_SIZE_1 11
...
extern __device__ limb_t STRATEGY2[57];
extern __device__ limb_t STRATEGY2_0[28];
extern __device__ limb_t STRATEGY2_1[28];

extern __device__ limb_t STRATEGY2_REDUCED_0[27];
extern __device__ limb_t STRATEGY2_REDUCED_1[27];
extern __device__ limb_t STRATEGY2_PC_0[11];
extern __device__ limb_t STRATEGY2_PC_1[11];
...
extern __device__ uint32_t STRATEGY3[36];
extern const uint32_t STRATEGY3_0[18];
extern const uint32_t STRATEGY3_1[17];
