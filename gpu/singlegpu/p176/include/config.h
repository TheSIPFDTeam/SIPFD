...
#define PC_DEPTH 24
#define PC_STRATEGY_SIZE_0 18
#define PC_STRATEGY_SIZE_1 18

#define EXPONENT2 88
#define EXPONENT2_BITS 88
#define EXPONENT2_MASK 0x255
#define EXP2_MASK_GPU 0xFFFFFF
...
extern __device__ limb_t STRATEGY2[87];
extern __device__ limb_t STRATEGY2_0[43];
extern __device__ limb_t STRATEGY2_1[43];

extern __device__ limb_t STRATEGY2_REDUCED_0[42];
extern __device__ limb_t STRATEGY2_REDUCED_1[42];
extern __device__ limb_t STRATEGY2_PC_0[18];
extern __device__ limb_t STRATEGY2_PC_1[18];

#define EXPONENT3 49
#define EXPONENT3_BITS 78
#define EXPONENT3_MASK 0x63
#define EXP3_MASK_GPU 0x3FFF

extern __device__ uint32_t STRATEGY3[48];
extern const uint32_t STRATEGY3_0[24];
extern const uint32_t STRATEGY3_1[23];
