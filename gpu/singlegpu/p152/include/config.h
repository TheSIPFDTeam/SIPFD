...
#define COFACTOR 19
#define PC_DEPTH 21
#define PC_STRATEGY_SIZE_0 15
#define PC_STRATEGY_SIZE_1 15
...
extern __device__ limb_t STRATEGY2[75];
extern __device__ limb_t STRATEGY2_0[37];
extern __device__ limb_t STRATEGY2_1[37];

extern __device__ limb_t STRATEGY2_REDUCED_0[36];
extern __device__ limb_t STRATEGY2_REDUCED_1[36];
extern __device__ limb_t STRATEGY2_PC_0[15];
extern __device__ limb_t STRATEGY2_PC_1[15];
...
extern __device__ uint32_t STRATEGY3[44];
extern const uint32_t STRATEGY3_0[22];
extern const uint32_t STRATEGY3_1[21];
