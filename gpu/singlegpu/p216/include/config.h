...
#define COFACTOR 19
#define PC_DEPTH 25
#define PC_STRATEGY_SIZE_0 27
#define PC_STRATEGY_SIZE_1 27

#define EXPONENT2 108
#define EXPONENT2_BITS 108
#define EXPONENT2_MASK 0x15
#define EXP2_MASK_GPU 0xFFF
...
extern __device__ limb_t STRATEGY2[107];
extern __device__ limb_t STRATEGY2_0[53];
extern __device__ limb_t STRATEGY2_1[53];

extern __device__ limb_t STRATEGY2_REDUCED_0[52];
extern __device__ limb_t STRATEGY2_REDUCED_1[52];
extern __device__ limb_t STRATEGY2_PC_0[27];
extern __device__ limb_t STRATEGY2_PC_1[27];

#define EXPONENT3 65
#define EXPONENT3_BITS 104
#define EXPONENT3_MASK 0x255
#define EXP3_MASK_GPU 0xFF

extern __device__ uint32_t STRATEGY3[64];
extern const uint32_t STRATEGY3_0[32];
extern const uint32_t STRATEGY3_1[31];
