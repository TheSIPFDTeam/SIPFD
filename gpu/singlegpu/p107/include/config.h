...
#define COFACTOR 41
#define PC_DEPTH 14
#define PC_STRATEGY_SIZE_0 9
#define PC_STRATEGY_SIZE_1 9
...
extern __device__ limb_t STRATEGY2[49];
extern __device__ limb_t STRATEGY2_0[24];
extern __device__ limb_t STRATEGY2_1[24];

extern __device__ limb_t STRATEGY2_REDUCED_0[23];
extern __device__ limb_t STRATEGY2_REDUCED_1[23];
extern __device__ limb_t STRATEGY2_PC_0[9];
extern __device__ limb_t STRATEGY2_PC_1[9];
