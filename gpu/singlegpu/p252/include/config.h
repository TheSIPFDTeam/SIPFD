...
#define COFACTOR 101
#define PC_DEPTH 16
#define PC_STRATEGY_SIZE_0 45
#define PC_STRATEGY_SIZE_1 45
...
extern __device__ limb_t STRATEGY2[125];
extern __device__ limb_t STRATEGY2_0[62];
extern __device__ limb_t STRATEGY2_1[62];

extern __device__ limb_t STRATEGY2_REDUCED_0[61];
extern __device__ limb_t STRATEGY2_REDUCED_1[61];
extern __device__ limb_t STRATEGY2_PC_0[45];
extern __device__ limb_t STRATEGY2_PC_1[45];

#define EXPONENT3 75
#define EXPONENT3_BITS 119
#define EXPONENT3_MASK 0x127
#define EXP3_MASK_GPU 0x7FFFFF

extern __device__ uint32_t STRATEGY3[74];
extern const uint32_t STRATEGY3_0[37];
extern const uint32_t STRATEGY3_1[36];
