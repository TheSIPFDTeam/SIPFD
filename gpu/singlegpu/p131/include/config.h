...
#define COFACTOR 85
#define PC_DEPTH 17
#define PC_STRATEGY_SIZE_0 13
#define PC_STRATEGY_SIZE_1 13

#define EXPONENT2 64
#define EXPONENT2_BITS 64
#define EXPONENT2_MASK 0x255
#define EXP2_MASK_GPU 0xFFFFFFFF
...
extern __device__ limb_t STRATEGY2[63];
extern __device__ limb_t STRATEGY2_0[31];
extern __device__ limb_t STRATEGY2_1[31];

extern __device__ limb_t STRATEGY2_REDUCED_0[30];
extern __device__ limb_t STRATEGY2_REDUCED_1[30];
extern __device__ limb_t STRATEGY2_PC_0[13];
extern __device__ limb_t STRATEGY2_PC_1[13];

#define EXPONENT3 38
#define EXPONENT3_BITS 61
#define EXPONENT3_MASK 0x31
#define EXP3_MASK_GPU 0x1FFFFFFF

extern __device__ uint32_t STRATEGY3[37];
extern const uint32_t STRATEGY3_0[18];
extern const uint32_t STRATEGY3_1[18];
