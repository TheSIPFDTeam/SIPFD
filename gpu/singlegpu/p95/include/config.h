...
#define COFACTOR 73
#define PC_DEPTH 12
#define PC_STRATEGY_SIZE_0 8
#define PC_STRATEGY_SIZE_1 8
...
extern __device__ limb_t STRATEGY2[43];
extern __device__ limb_t STRATEGY2_0[21];
extern __device__ limb_t STRATEGY2_1[21];

extern __device__ limb_t STRATEGY2_REDUCED_0[20];
extern __device__ limb_t STRATEGY2_REDUCED_1[20];
extern __device__ limb_t STRATEGY2_PC_0[8];
extern __device__ limb_t STRATEGY2_PC_1[8];

#define EXPONENT3 28
#define EXPONENT3_BITS 45
#define EXPONENT3_MASK 0x31
#define EXP3_MASK_GPU 0x1FFF

extern __device__ uint32_t STRATEGY3[27];
extern const uint32_t STRATEGY3_0[13];
extern const uint32_t STRATEGY3_1[13];
